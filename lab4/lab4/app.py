...
app.config['MAIL_USERNAME'] = 'lab4saliucartur21@outlook.com'  #mail
app.config['MAIL_PASSWORD'] = '123321qwerty'  #pass
app.config['MAIL_DEFAULT_SENDER'] = 'lab4saliucartur21@outlook.com'  #sender
